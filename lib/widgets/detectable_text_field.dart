...
///
/// To integrate the [DetectableTextField] into a [Form] with other [FormField] widgets,
...
///
/// {@tool snippet}
/// This example shows how to create a [DetectableTextField] that will obscure input. The
...
class DetectableTextField extends StatefulWidget {
  ...
  /// [DetectableTextField.noMaxLength] then only the current length is displayed.
  ///
  ...
  const DetectableTextField({
    ...
    this.restorationId,
        ...
        assert(maxLength == null ||
            maxLength == DetectableTextField.noMaxLength ||
            maxLength > 0),
  ...
  /// to [DetectableTextField.noMaxLength] then only the current character count is displayed.
  ///
  /// After [maxLength] characters have been input, additional input
  /// is ignored, unless [maxLengthEnforcement] is set to
  /// [MaxLengthEnforcement.none].
  ...
  /// which is evaluated after the supplied [inputFormatters], if any.
  ///
  /// This value must be either null, [DetectableTextField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [DetectableTextField.noMaxLength], then no limit will
  ...
  ///
  /// The [mouseCursor] is the only property of [DetectableTextField] that controls the
...
class _DetectableTextFieldState extends State<DetectableTextField>
  ...
  @override
  void didUpdateWidget(DetectableTextField oldWidget) {
