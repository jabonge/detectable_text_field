...
/// TextField which detects the text with [detectionRegExp].
///
/// Using [DetectableEditableText] instead of [EditableText] to enable detection.
...
class _DetectableTextFieldState extends State<DetectableTextField>
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle detectedStyle =
        widget.detectedStyle ?? style.copyWith(color: Colors.blue);
    final Brightness keyboardAppearance =
